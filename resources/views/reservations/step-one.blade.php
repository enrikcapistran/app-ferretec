                        ...
                        <div class="w-full">
                            ...
                            <form method="POST" action="{{ route('reservations.store.step.one') }}">
                                ...
                                <div class="sm:col-span-6">
                                    <label for="first_name" class="block text-sm font-medium text-gray-700"> Nombre(s)
                                    </label>
                                    <div class="mt-1">
                                ...
                                <div class="sm:col-span-6">
                                    <label for="last_name" class="block text-sm font-medium text-gray-700"> Apellido(s)
                                    </label>
                                    <div class="mt-1">
                                ...
                                <div class="sm:col-span-6">
                                    <label for="tel_number" class="block text-sm font-medium text-gray-700"> Teléfono
                                    </label>
                                    <div class="mt-1">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <span class="text-xs">Seleccione un hora entre 10:00AM y 9:00PM.</span>
                                    @error('res_date')
                                        <div class="text-sm text-red-400">{{ $message }}</div>
                                    @enderror
                                </div>
